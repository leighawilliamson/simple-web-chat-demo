...
/*
    ...
    user = args[1];
    password = args[2]; */
//    full_url = "jdbc:db2://2c2b8d15-daf6-4a01-a528-1760858e5607.bpe60pbd01oinge4psd0.databases.appdomain.cloud:30653/bludb:user=i6sa4dlx;password=LROvZno64GBtC9g0;sslConnection=true;";
    url = "jdbc:db2://2c2b8d15-daf6-4a01-a528-1760858e5607.bpe60pbd01oinge4psd0.databases.appdomain.cloud:30653/bludb:sslConnection=true;";
    user = "i6sa4dlx";
    password = "LROvZno64GBtC9g0";
    try
    {
      // Load the driver
      ...
      rs = stmt.executeQuery("SELECT * FROM WATSON.WA_FULL_LOGS WHERE INPUT_TEXT=S##t!;");
      System.out.println("**** Created JDBC ResultSet object");

      // Print all of the employee numbers to standard output device
      while (rs.next()) {
        empNo = rs.getString(1);
        System.out.println("First record = " + empNo);
      }
